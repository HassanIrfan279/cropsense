...
// The base URL is loaded from .env at runtime (see api_service.dart).
// ─────────────────────────────────────────────────────────────────────────
class ApiEndpoints {
  ...
  static String stats(String district) =>
      '/api/stats/$district';
}
...
class CacheDurations {
  ...
  static const Duration riskMap      = Duration(hours: 1);
  static const Duration aiAdvice     = Duration(hours: 6);
  static const Duration yieldData    = Duration(hours: 12);
...
class AppDistricts {
  static const List<Map<String, String>> all = [
    ...
    {'id': 'abbottabad',   'label': 'Abbottabad',      'province': 'Khyber Pakhtunkhwa'},
    {'id': 'charsadda',    'label': 'Charsadda',       'province': 'Khyber Pakhtunkhwa'},
    {'id': 'dera-ismail-khan', 'label': 'Dera Ismail Khan', 'province': 'Khyber Pakhtunkhwa'},
