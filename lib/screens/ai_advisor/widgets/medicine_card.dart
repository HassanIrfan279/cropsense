...
class _MedicineCardState extends State<MedicineCard>
  ...
  IconData get _typeIcon {
    switch (widget.type) {
      case 'fungicide':  return Icons.spa_rounded;
      case 'pesticide':  return Icons.bug_report_rounded;
      case 'herbicide':  return Icons.grass_rounded;
      case 'fertilizer': return Icons.eco_rounded;
      case 'growth_reg': return Icons.science_rounded;
  ...
  String get _typeLabel {
    switch (widget.type) {
      ...
      case 'growth_reg': return 'Growth Regulator';
        ...
        AnimatedSize(
          ...
          child: _expanded
            ? Padding(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  _row(Icons.science_rounded, 'Dose',
                    widget.dose, AppColors.skyBlue),
                  const Divider(height: 14, color: AppColors.grey200),
                  _row(Icons.currency_rupee_rounded, 'Cost/acre',
                    formatPKR(widget.pricePerAcre), AppColors.limeGreen),
                  const Divider(height: 14, color: AppColors.grey200),
                  _row(Icons.info_outline_rounded, 'Treats',
                    widget.purpose, color),
                  const Divider(height: 14, color: AppColors.grey200),
                  _row(Icons.store_rounded, 'Buy at',
                    widget.whereToBuy, AppColors.deepGreen),
                ]),
              )
