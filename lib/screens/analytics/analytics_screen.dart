...
class _AnalyticsScreenState extends ConsumerState<AnalyticsScreen> {
  ...
  static const _provinceYields = {
    'Punjab': 2.4, 'Sindh': 1.9, 'KPK': 2.1, 'Balochistan': 1.2,
  };
      ...
      child: Row(
        children: [
          ...
          DropdownButton<String>(
            ...
            items: AppDistricts.all.take(12).map((d) => DropdownMenuItem<String>(
          ...
          DropdownButton<String>(
            ...
            underline: const SizedBox.shrink(),
            style: const TextStyle(fontSize: 13, color: Color(0xFF1A1A1A)),
            items: AppCrops.all.map((c) => DropdownMenuItem<String>(
  ...
  Widget _buildChartGrid(List<Map<String, dynamic>> data, Map<String, double> pYields, bool isCompact, bool isWide) {
    final charts = [
      NdviChart(data: data),
