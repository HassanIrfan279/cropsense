...
final cropYieldProvider = AsyncNotifierProviderFamily<CropYieldNotifier, YieldDataResponse, (String, String)>(CropYieldNotifier.new);

class CropYieldNotifier extends FamilyAsyncNotifier<YieldDataResponse, (String, String)> {
  @override
